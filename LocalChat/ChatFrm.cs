  ...
  {   
    ...
    private void DisplayMsg(String userTime, String msg, String user) {
      lock (this) {
        ...
        if(user.Equals(myUsername))
        {
          ...
          tbMessages.SelectionAlignment = HorizontalAlignment.Right;
        }
        else{
          userColor = Color.Blue;
          tbMessages.SelectionAlignment = HorizontalAlignment.Left;
    ...
    public void printMsg(MessageEventArgs e)
    {
      if (e.messageSet)
      {
        ...
        notifyIcon1.ShowBalloonTip(5000, "Täze habar!", messageStr.ToString(), ToolTipIcon.Info);
